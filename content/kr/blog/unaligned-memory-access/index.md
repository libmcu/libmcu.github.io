...
>
> 포인터는 원래의 오브젝트 타입과 다른 타입의 포인터로 변환될 수 있습니다. 다른
> 타입으로 변환한 포인터로 메모리 접근할 때 메모리가 변환된 타입에 맞게
> 정렬되어 있지 않은 경우 동작은 정의되어 있지 않습니다. 그렇지 않은 경우, 원래
> 오브젝트 타입으로 다시 변환할 때 기존 포인터와 동일한 주소인지 비교해야
> 합니다. 문자형 타입으로 변환할 경우 기존 오브젝트의 최하위 주소를 가리킵니다.
